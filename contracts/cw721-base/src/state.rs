...
use crate::msg::SaleConfigResponse;
    ...
    E: CustomMsg,
{
    ...
    pub collection_size: Item<'a, u64>,
    pub base_token_uri: Item<'a, String>,
    ...
    Q: CustomMsg,
{
    ...
    fn new(
        ...
        Self {
            ...
            collection_size: Item::new(collection_size_key),
